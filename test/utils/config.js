...
exports.retinaMultipleSprites = {
  ...
  retinaSprites: [{
    name: 'sprite-dash-case', x: 0, y: 0, width: 20, height: 40
  }, {
    name: 'sprite_snake_case', x: 20, y: 40, width: 40, height: 60
  }, {
    name: 'spriteCamelCase', x: 60, y: 100, width: 100, height: 100
  }],
  retinaSpritesheet: {
