...
function templater(params, options) {
  ...
  if (params.retinaSprites || params.retinaSpritesheet || params.retinaGroups) {
    ...
    // DEV: If `retinaGroups` becomes too complex to maintain due to duplicate data
    //   then, consider moving to indicies or strings (names) instead of objects
    //   and we perform mapping to normal/retina objects
