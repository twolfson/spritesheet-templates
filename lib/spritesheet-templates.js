...
templater.addMustacheTemplate = function (name, tmplStr) {
  ...
  function templateFn(itemObj) {
    ...
    // TODO: Support arrays of caseMethod (e.g. `[underscore, toUpperCase]` to get `HELLO_WORLD`)
    // TODO: Rename to variableNameTransforms
    var caseMethod = itemObj.options.caseMethod ? _s[itemObj.options.caseMethod] : _.identity;
