...
function templater(data, options) {
  ...
  // DEV: Disabling ESLint for this block since it stylistically feels easier to skim (2026-08-04)
...
templater.escapeImage = function (spritesheet) {
  ...
  // DEV: Added eslint-disable-next-line -- restoring test suite, not making potentially breaking changes (2026-08-04)
