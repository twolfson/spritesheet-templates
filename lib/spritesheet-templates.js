...
function templater(data, options) {
  ...
  if (data.retina_sprites || data.retina_spritesheet || data.retina_groups) {
    ...
    // TODO: I believe we changed this from last time. No longer thing `spritesheet` retina makes sense as we are always prefixing.
    ...
    retinaGroupsInfo.name = retinaSpritesheetInfo.name || 'retina-groups';
