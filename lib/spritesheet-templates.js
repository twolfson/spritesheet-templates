...
templater.ensureMustacheVariables = function (item, caseMethod) {
  ...
  _.extend(item.strings, {
    ...
    bare_offset_x: _s[caseMethod]('offset-x'),
    bare_offset_y: _s[caseMethod]('offset-y'),
    bare_width: _s[caseMethod]('width'),
    bare_height: _s[caseMethod]('height'),
    bare_total_width: _s[caseMethod]('total-width'),
    bare_total_height: _s[caseMethod]('total-height'),
...
templater.addMustacheTemplate = function (name, tmplStr) {
  ...
  function templateFn(itemObj) {
    ...
    templater.ensureMustacheVariables(itemObj, caseMethod);
