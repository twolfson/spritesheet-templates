...
function templater(params, options) {
  ...
  if (params.retinaSprites || params.retinaSpritesheet || params.retinaGroups) {
    ...
    retinaGroups.name = retinaGroups.name || 'retina-sprites';
...
templater.addHandlebarsTemplate = function (name, tmplStr) {
  ...
  function templateFn(data) {
    ...
    if (data.retina_groups) {
      templater.ensureHandlebarsVariables(data.retina_groups, transformFn);
      data.retina_groups.groups.forEach(function addHandlebarsVariables (retinaGroup) {
