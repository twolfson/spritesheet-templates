 ...
 * @param {Number} params.items.*.width Horizontal length of image
 * @param {Number} params.items.*.height Vertical length of image
 ...
 */
// TODO: Update README doc block
// TODO: Update docs/
// TODO: Update test/
// TODO: Update all of README
...
templater.addSpritesheetProperties = function (item, spritesheet) {
  ...
  // Save the image and escapedImg for later
  item.image = img;
  item.escaped_image = escapedImg;

  // Save additional spritesheet info
