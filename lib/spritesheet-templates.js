...
templater.addHandlebarsTemplate = function (name, tmplStr) {
  ...
  function templateFn(itemObj) {
    ...
    templater.ensureHandlebarsVariables(itemObj, transformFn);
    templater.ensureHandlebarsVariables(itemObj.spritesheet, transformFn);
    itemObj.items.forEach(function addHandlebarsVariables (item) {
      templater.ensureHandlebarsVariables(item, transformFn);
    });
