 ...
 * @param {String} input[*].name Name of the input item
 * @param {String} input[*].x X coordinate of the input item
 * @param {String} input[*].y Y coordinate of the input item
 * @param {String} input[*].height Height of the input item
 * @param {String} input[*].width Width of the input item
 * @param {String} input[*].total_height Height of the input item's image
 * @param {String} input[*].total_width Width of the input item's image
